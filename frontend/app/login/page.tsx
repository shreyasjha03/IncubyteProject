      ...
      <div className="max-w-md w-full space-y-6 glass bg-white/90 backdrop-blur-xl p-8 sm:p-10 rounded-3xl shadow-2xl border border-white/40 relative z-10 animate-slide-up">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600 font-medium text-base">Welcome back! Sign in to your account</p>
          </div>
        </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-sm font-medium text-amber-600 hover:text-amber-700 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-1 rounded"
                >
                  Forgot password?
                </Link>
              </div>
