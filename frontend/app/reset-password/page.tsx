  ...
  if (!tokenValid) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-md w-full glass bg-white/90 backdrop-blur-xl p-8 sm:p-10 rounded-3xl shadow-2xl border border-white/40 relative z-10 animate-slide-up">
          <div className="text-center space-y-4">
            <div className="text-6xl">⚠️</div>
            <h2 className="text-3xl font-bold font-display text-gray-900">Invalid Reset Link</h2>
            ...
            <div className="pt-4 space-y-3">
              ...
              <Link
                href="/login"
                className="block text-sm font-medium text-amber-600 hover:text-amber-700 transition-colors"
              >
                Back to login
              </Link>
            </div>
      ...
      <div className="max-w-md w-full space-y-6 glass bg-white/90 backdrop-blur-xl p-8 sm:p-10 rounded-3xl shadow-2xl border border-white/40 relative z-10 animate-slide-up">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600 font-medium text-base">Create a new password</p>
          </div>
        </div>
        ...
        {success && (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs mt-1 text-green-600">Redirecting to login page...</p>
            </div>
          </div>
        )}
